...
#define NETWORK_DEVICE_AVRO_FILENAME			"NetworkDevicesStatus.avsc"
#else
#define NETWORK_DEVICE_AVRO_FILENAME			"/usr/ccsp/lm/NetworkDevicesStatus.avsc"
#endif
...
struct networkdevicedata *next;
};

/**
 * @brief To send the network devices report to webpa
*/
void lmlite_report_networkdevices(struct networkdevicedata *ptr);
